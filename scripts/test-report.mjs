...
const CATEGORIES = [
  ...
  { name: 'Economy     资源经济', match: ['economySim', 'lootSim', 'loot.spec', 'petLuck', 'pillValue', 'veinEconomyAudit', 'veinVisibility', 'resourceGuidance', 'offlineCap', 'veinService', 'qiRepair'] },
  {
    ...
    match: ['loadoutService', 'battleAnalysis', 'loreService', 'contentReachability', 'mentorService', 'daoluService', 'bondEvents', 'bondTiming', 'bondIntent', 'bondCausality', 'worldMemory', 'phase31LinkAudit', 'suppress', 'game.spec', 'earlyGameService', 'earlyGameBuffs', 'savePlatform', 'dataHeaderAudit', 'deadExportAudit', 'chainProgression', 'vocabularyCoverage', 'storeResilience', 'rewardReachability', 'dataIntegrity']
  },
