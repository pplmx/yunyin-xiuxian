...
const CATEGORIES = [
  ...
  { name: 'Economy     资源经济', match: ['economySim', 'lootSim', 'loot.spec', 'pillValue', 'veinEconomyAudit', 'veinVisibility', 'resourceGuidance'] },
  {
    name: 'Regression  服务与归因',
    match: ['loadoutService', 'battleAnalysis', 'loreService', 'contentReachability', 'mentorService', 'daoluService', 'bondEvents', 'bondTiming', 'bondIntent', 'bondCausality', 'worldMemory', 'phase31LinkAudit', 'suppress', 'game.spec', 'earlyGameService', 'savePlatform']
  },
