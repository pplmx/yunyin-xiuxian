...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  // ---- 仙界及以上 ----
  ac('a_r10', '玄之又玄', '突破玄仙境', { type: 'realm', major: 10 }, { stoneTier: 340, wudao: 240 }),
  ac('a_r11', '金性不朽', '突破金仙境', { type: 'realm', major: 11 }, { stoneTier: 380, wudao: 300 }),
  ac('a_r12', '太乙近道', '突破太乙境', { type: 'realm', major: 12 }, { stoneTier: 420, wudao: 360 }),
  ac('a_r13', '大罗逍遥', '突破大罗境', { type: 'realm', major: 13 }, { stoneTier: 460, wudao: 420 }),
  ac('a_r14', '神光照世', '踏入神界,证得神人境', { type: 'realm', major: 14 }, { stoneTier: 520, wudao: 500 }),
  ac('a_r15', '代天行罚', '突破神将境', { type: 'realm', major: 15 }, { stoneTier: 580, wudao: 580 }),
  ac('a_r16', '神域之主', '突破神王境', { type: 'realm', major: 16 }, { stoneTier: 640, wudao: 660 }),
  ac('a_r17', '神帝临尘', '突破神帝境', { type: 'realm', major: 17 }, { stoneTier: 720, wudao: 760 }),
  ac('a_r18', '混沌真灵', '踏入混沌海,证得混沌真灵', { type: 'realm', major: 18 }, { stoneTier: 820, wudao: 880 }),
  ac('a_r19', '开天辟地', '突破混沌神魔,神魔一体', { type: 'realm', major: 19 }, { stoneTier: 940, wudao: 1000 }),
  ac('a_r20', '万道之祖', '证道混沌道祖,与混沌同寿', { type: 'realm', major: 20 }, { stoneTier: 1200, wudao: 1300 }),
  // ---- 突破 ----
